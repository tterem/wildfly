...
dependencies to the JBoss Module of every Jakarta EE deployment. Such
...
All resources will be available on the application class loader. For example, you could access to the above property files using the context ClassLoader of your current thread:
