...
import org.wildfly.test.integration.microprofile.metrics.application.TestApplication;
...
public class MicroProfileMetricsCounterMultipleInvocationsTestCase {
   ...
   public void testMultipleInvocationsOfEndpoint(@ArquillianResource URL url) throws Exception {
      ...
      int statsHits = jsonObject.getInt("helloCounter");

      Assert.assertTrue("Expected value of 'helloCounter' is 5, but was " + statsHits, statsHits == 5);
   }
}
