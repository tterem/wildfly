 ...
 * This processor ensures that the GlobalDirectoryDeploymentService installed for this deployment is up before moving
 * to the next phase.
 *
 * @author Yeray Borges
 */
public class GlobalDirectoryDependencyProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        GlobalDirectoryDeploymentService globalDirDepService = new GlobalDirectoryDeploymentService(allDirReadySuppliers, externalModuleService, moduleSpecification, moduleLoader);
